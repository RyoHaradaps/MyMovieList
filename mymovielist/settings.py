...
SECRET_KEY = "django-insecure-z9e95+f)3yq6$zg%ymx_qu2zb198*u6x_(77+%u_iu9%=!fs$a"
...
INSTALLED_APPS = [
    ...
    'core',                         # Custom app for movie list functionality
    'crispy_forms',                 # Django Crispy Forms for better form rendering
    'crispy_bootstrap5',            # Bootstrap 5 template pack for Crispy Forms
]

CRISPY_TEMPLATE_PACK = 'bootstrap4'  # or 'bootstrap5'      # Template pack for Crispy Forms
...
TMDB_API_KEY = '28d27a694a324a1f8c2c0a869b2f7065'
